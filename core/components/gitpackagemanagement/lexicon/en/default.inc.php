...
$_lang['setting_gitpackagemanagement.disable_create_elements'] = 'scip creating anything in the MODX db';
...
$_lang['setting_gitpackagemanagement.disable_update_elements'] = 'scip updating anything in the MODX db';
