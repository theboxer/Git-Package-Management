<?php
namespace GitPackageManagement\Builder;
...
class Builder {
    ...
    public function putVehicle(Vehicle $vehicle) {
    ...
    public function pack() {
        $this->builder->pack();
        if ($this->gpm->getOption('remove_extracted_package')) {
            $this->gpm->deleteDir($this->builder->directory . $this->builder->signature . '/');
        }
    ...
    public function createVehicle($object, $type) {
        return new Vehicle($this->builder, $this->smarty, $object, $this->getAttributes($type));
    }
