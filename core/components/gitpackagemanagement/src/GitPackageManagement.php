...
class GitPackageManagement
{
    ...
    public static $configPath = '/_build/config.json';
    ...
    function __construct(modX &$modx, array $options = [])
    {
        ...
        $assetsPath = $this->getOption(
            'assets_path',
            $options,
            $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/gitpackagemanagement/'
        );
    ...
    public function runProcessor($action = '', $scriptProperties = [], $location = '')
    {
    ...
    public function findCategory(array $path, $root)
    {
        ...
        foreach ($path as $name) {
            $category = $this->modx->getObject(\MODX\Revolution\modCategory::class, ['parent' => $currentParent, 'category' => $name]);
